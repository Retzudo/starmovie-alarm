"""
Django settings for starmoviealert project.
...
DEBUG = os.getenv('SMALERT_DEBUG', False)

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv('SMALERT_SECRET_KEY', os.urandom(24))

if not DEBUG:
    ALLOWED_HOSTS = ['starmovie.retzudo.com']
...
ROOT_URLCONF = 'starmoviealert.urls'
...
WSGI_APPLICATION = 'starmoviealert.wsgi.application'
